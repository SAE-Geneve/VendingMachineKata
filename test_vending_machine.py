...
def test_select_product_exact_changes(vending_machine_sold_out, coin_quarter):
    ...
    initial_sum = vending_machine_sold_out.get_storage_sum()
    ...
    assert vending_machine_sold_out.get_storage_sum() == initial_sum + product_price_map.get(ProductType.COLA)
...
def test_make_changes(vending_machine_sold_out, coin_quarter, coin_nickel, coin_dime):
    ...
    vending_machine_sold_out.add_storage(coin_nickel)
